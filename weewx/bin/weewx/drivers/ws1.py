...
class StationData(object):
    ...
    def parse_readings(raw):
        ...
        data['outTemp'] = StationData._decode(buf[20:24], 0.1, True)  # degree_F - was inTemp
        #data['outHumidity'] = StationData._decode(buf[24:28], 0.1)  # percent
        data['outHumidity'] = StationData._decode(buf[28:32], 0.1)  # percent - ws inHumidity
